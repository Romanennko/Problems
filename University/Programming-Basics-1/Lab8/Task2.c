...
void show_sizes(const union personal_data *);
void show_addresses(const union personal_data *);

int main()
{
   union personal_data person;
   printf("\nThe union 'personal_data' has a size of %d byte(s).\n\n", sizeof(person));
   show_sizes(&person);
   puts("");
   puts("");
...
void show_sizes(const union personal_data *data)
{
   ...
   puts("**************************************************");
   printf("  Total size of personal_data: %d byte(s).\n", sizeof(data->first_name) + sizeof(data->number1) + sizeof(data->last_name) + sizeof(data->number2));
   puts("**************************************************");
   return;
}

void show_addresses(const union personal_data *data)
{
